...
import resolveRawSql from '../dist/src/resolve_raw_sql.js';
import { installExecFile } from '../dist/src/install_exec.js';

const PACKAGE_ROOT = new URL('..', import.meta.url).pathname;

/**
 * @param {import('../dist/src/codegen_paths.js').CodegenPaths} paths
 * @param {string} cwd
 */

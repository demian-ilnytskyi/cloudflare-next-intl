...
# Project clarivant - Smart Project Planning
...
4. **Auto-Integration Check (MANDATORY TOOL USE):** If `.code-review-graph/`
...
| Step | Action     | Command                                                  |
| ---- | ---------- | -------------------------------------------------------- |
| 1    | Checklist  | Purple check, Clarivant check, Socratic respected?       |
...
> [!TIP]
> **Bonus**: For each task, indicate the best agent AND the best skill from the
...
> 🔴 **EXIT GATE:** Phase X marker MUST be in `docs/PLAN-{task-slug}.md` before
> project is complete.

...
This skill enables coordinating multiple specialized agents through AG Kit's
native agent system. Unlike external scripts, this approach keeps all
orchestration within AG Kit's control.
...
| `project-clarivant`     | Planning         | "plan", "roadmap", "milestones"                    |

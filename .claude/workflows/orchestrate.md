...
| **Full Stack** | project-clarivant, frontend-specialist, backend-specialist, devops-engineer |
...
| Step | Agent                       | Action                       |
| ---- | --------------------------- | ---------------------------- |
| 1    | `project-clarivant`         | Create docs/PLAN.md          |
| 2    | (optional) `explorer-agent` | Codebase discovery if needed |

> 🔴 **NO OTHER AGENTS during planning!** Only project-clarivant and
> explorer-agent.
...
| ----------------------- | --------- | ----------------------- |
| `project-clarivant`     | Planning  | Task breakdown, PLAN.md |
...
```
Use the project-clarivant agent to create PLAN.md
...
| - | ------------------- | -------------------- | ------ |
| 1 | project-clarivant   | Task breakdown       | ✅     |

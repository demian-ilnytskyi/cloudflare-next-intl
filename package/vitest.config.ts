...
export default defineConfig({
    test: {
        ...
        coverage: {
            ...
            thresholds: {
                perFile: true,
                'src/**/!(general_functions|middleware|error_detail_view|errors_list_client).{ts,tsx}': { statements: 100, branches: 100, functions: 100, lines: 100 },
                ...
                // errors_list_client.tsx: handleBulkStatus/handleBulkDelete's `ids.length === 0` early-return guards are only reachable when their trigger buttons are `disabled`, and a disabled button's onClick never fires under fireEvent.click in jsdom.
                'src/errors_board/client/errors_list_client.tsx': { statements: 100, branches: 94, functions: 83.33, lines: 100 },
            },
        },
    },
    resolve: {
